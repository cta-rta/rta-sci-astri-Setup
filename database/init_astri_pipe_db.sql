...
INSERT INTO instrument (instrumentid,name,fov,irf,caldb) VALUES (10,'ASTRI',5,'Astri_50h','prod2');
...
INSERT INTO energybingroup (energybingroupid,shortname,description,energyreftypeid) VALUES (2,'ASTRI','ASTRI-BAND',1);

INSERT INTO energybin (energybinid,energybingroupid,emin,emax) VALUES (1,1,0.1,100);
INSERT INTO energybin (energybinid,energybingroupid,emin,emax) VALUES (2,2,0.631,350);
...
VALUES
	(1,1,0,'EVT3_ASTRI','ASTRI repo of EVT3 files on database',1);
...
VALUES
	(1,'ASTRI','ASTRI',0,1,10,NULL,'/ANALYSIS3/','/ANALYSIS3/RUN/',1),
...
VALUES
    (1,'ctools','. /usr/share/modules/init/bash\nmodule load astri_rta_pipe_build1\nsource activate astri_pipe\ngammalibinit\nctoolsinit',1,2,1);
...
VALUES
  ...
  VALUES
  	...
  	(15,'','LC1000-shift10-b',1,'LC1000-shift10-b',5,1,0,0,1000,1000,0,10,0,'large','large_rt',1,1,NULL,5,1),
		(16,'','LC-from-start',1,'LC-from-start',1,1,0,0,-2,0,0,10,1,'large','large_rt',2,1,NULL,5,1);
